...
API_ID = int(environ.get('API_ID', '27963649'))
API_HASH = environ.get('API_HASH', 'b5a24fc9b7091153663c263f883cf85c')
BOT_TOKEN = environ.get('BOT_TOKEN', "6950514128:AAGN6UZjVwNZUh2Ksqn_1W7H_XXw0MsTfNA")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002064186792'))
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002064312182')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002045793082')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://narutouzmakie008:fgng70HrvIeP3eSC@cluster0.qhn8vbt.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/shooooo019')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/joker67034')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/anime98878') # Support Chat Link Without https:// or @
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://tall-lillis-sahiljokerorganization.koyeb.app/")
